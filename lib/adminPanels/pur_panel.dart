...
import 'package:policesystem/user_panel/purpose_form.dart';
...
class _PurPanelState extends State<PurPanel> {
          ...
          SpeedDialChild(
              ...
              onTap: () {
                Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const PurposeForm()))
                    .then((value) {
                  setState(() {});
                });
              },
  ...
  DataTableSource dataSource(List<Purpose> purList) =>
      MyData(dataList: purList);
}

class MyData extends DataTableSource {
  MyData({required this.dataList});
  late final List<Purpose> dataList;
